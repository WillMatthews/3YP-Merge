...
As an aside, \code{\color{blue}lqr} works as a \emph{known solution} to the above cost function is $G = R^{-1} ( B^T P)$, where $P$ is found from solving the Algebraic Riccati Equation: $A^T P + PA - PBR^{-1}B^TP = 0$. \cite{power:controlman}
